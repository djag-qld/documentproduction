...
public class OcspHelper
{
    ...
    private static final LoadingCache<OcspKey, OcspHelper> INSTANCES = CacheBuilder.newBuilder().maximumSize(100).expireAfterWrite(24, TimeUnit.HOURS)
    		.build(new CacheLoader<OcspKey, OcspHelper>() {
    			...
    			public OcspHelper load(OcspKey key) throws IOException, GeneralSecurityException, OCSPException, RevokedCertificateException {
    				OcspHelper instance = getInstance(key.getCheckCertificate(), new Date(), key.getIssuerCertificate(), key.getAdditionalCerts(), key.getOcspUrl());
    				LOG.info("New OCSP request to: {}", key.getOcspUrl());
    				instance.getResponseOcsp();
    ...
    private OcspHelper(X509Certificate checkCertificate, Date signDate, X509Certificate issuerCertificate,
    ...
    public static OcspHelper getInstance(OcspKey key) throws ExecutionException {
     ...
     */
    private static OcspHelper getInstance(X509Certificate checkCertificate, Date signDate, X509Certificate issuerCertificate,
            Set<X509Certificate> additionalCerts, String ocspUrl)
    {
    	return new OcspHelper(checkCertificate, signDate, issuerCertificate, additionalCerts, ocspUrl);
    }
    ...
    {
    	LOG.info("Performing OCSP request");
        ...
        try
        {
            ...
            {
            	LOG.info("Done performing OCSP request");
    ...
    private OCSPReq generateOCSPRequest() throws OCSPException, IOException
    {
        ...
        try
        {
            certId = new CertificateID(new SHA1DigestCalculator(),
                    ...
                    checkCertificate.getSerialNumber());
        }
